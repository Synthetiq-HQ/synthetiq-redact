        ...
        <div className="screen-container flex items-center justify-between py-3">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="rounded-lg bg-red-900 px-3 py-2 text-xs font-medium text-red-200 hover:bg-red-800"
            >
              ⚠️ Review
            </button>
            <button
              onClick={() => setScreen('batch')}
              className="rounded-lg bg-blue-900 px-3 py-2 text-xs font-medium text-blue-200 hover:bg-blue-800"
            >
              📦 Batch
            </button>
            <button
